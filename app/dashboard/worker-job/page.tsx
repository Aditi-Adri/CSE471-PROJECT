...
// + AI Predictive Planner — self-fetching client section (derives the
// authenticated workerId server-side via GET /api/worker/income and
// GET /api/worker/coaching, not passed as a prop).
import { IncomeIntelligenceSection } from "@/components/worker/income/IncomeIntelligenceSection";
...
export default async function WorkerJobDashboardPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
      ...
      {/* MODULE 2 -> FEATURE 4 (Jishan): Worker Income Intelligence
          Dashboard + AI Predictive Planner. */}
      <section>
        <IncomeIntelligenceSection />
      </section>
