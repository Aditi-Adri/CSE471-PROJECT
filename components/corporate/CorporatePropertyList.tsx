...
export function CorporatePropertyList({ onBookingCreated }: { onBookingCreated?: () => void }) {
  ...
  // fetchProperties only sets state after its `await fetch(...)`
  // resolves — a real async boundary, just not written as the
  // `.then()` callback shape this lint rule's static analysis looks for.
